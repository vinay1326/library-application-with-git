...
export const CheckOutReviewBox: React.FC<{ book: BookModel | undefined, mobile: boolean,
...
checkoutBook:any, isReviewLeft: boolean, submitReview: any}> = (props) => {
    ...
    function reviewRender() {
        if(props.isAuthenticated && !props.isReviewLeft){
            ...
            return(<p><b>Thankyou for you review!</b></p>)
        }
    ...
    return (
        <div className={props.mobile ? 'card d-flex mt-5' : 'card col-3 container d-flex mb-5'}>
            <div className='card-body contianer'>
                <div className="mt-3">
                    <p>
