...
export const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        const fetchBookReviews =async () => {
            ...
            let weightStartReviews: number =0;
            ...
            for(const key in responseData){
                ...
                weightStartReviews = weightStartReviews + responseData[key].rating;


            }
            if(loadedReviews){
                const round =(Math.round((weightStartReviews/loadedReviews.length)*2)/2).toFixed(1);
        ...
        const fetchUserCheckedOutBook = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                if (!bookCheckedOut.ok) {
                    throw new Error('Something went wrong in fetchUserCheckedOutBook!');
                }
